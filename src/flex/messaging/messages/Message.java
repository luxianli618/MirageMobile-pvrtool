        ...
        extends Serializable, Cloneable, Comparable<Message> //, javax.jms.Message
{
    ...
    /** Writes object as Small Message to the output stream */
    void writeSmallMessage(ObjectOutputStream oos) throws IOException;
    
    /** Reads object in Small Message format from the input stream */
    void readSmallMessage(ObjectInputStream ois) throws IOException, ClassNotFoundException;
}