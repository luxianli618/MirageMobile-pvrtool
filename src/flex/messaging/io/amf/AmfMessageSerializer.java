...
public class AmfMessageSerializer implements MessageSerializer
{
     ...
     * This used to be -1 but -1 is used as a separator in WebSocket text frames.
     * Changed it to 1 instead. Content length is simply read and discarded
     * in deserializer, so this shouldn't be a problem.
     */
