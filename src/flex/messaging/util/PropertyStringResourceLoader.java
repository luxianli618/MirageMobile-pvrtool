...
{
    // The default property file bundle that contains localized error strings.
    ...
    // The property bundle name to use in string lookups.
     ...
     * property bundle specified by the <code>PROPERTY_BUNDLE</code> field.
     */
     ...
     *
     * @param propertyBundle The name of the property bundle to use for lookups.
     */
    public PropertyStringResourceLoader(String propertyBundle)
    {
        this.propertyBundle = propertyBundle.replace('.', '/');
